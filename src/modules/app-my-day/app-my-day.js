...
import {useState} from 'react';
 function MyDay(props) {
  ...
  const getAlertOfUpdate = () => {

    alert('Hello user! Now I added small update. You can see two new tabs. Those tabs are main goals and usually. How you understand main goals was already before, but I decided to make tab for it. And about usually.. So for now it is a secret :)) You can write to my direct: larkessss If you have some problems with my app')

    localStorage.setItem('update','checked')
  ...
  if(localStorage.getItem('update') === null){
    ...
    localStorage.setItem('update','notchecked')

  }

  if(localStorage.getItem('update') === 'notchecked'){
    getAlertOfUpdate()
  }
